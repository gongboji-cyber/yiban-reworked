    ...
    <div className="workspace-grid">
      ...
      <section className="glass-card workspace-side">
        ...
        {result ? (
            ...
            <div className={`info-card risk-card risk-${result.risk_level || 'low'}`}>
              ...
              {result.risk_level === 'high' ? (
                <div className="risk-actions">
                  <a className="primary-btn" href={schoolAppointmentUrl} target="_blank" rel="noreferrer">
          ...
          <p className="empty-hint">还没有结果。先在左侧写下今天的感受。</p>
        )}
      </section>
    </div>
  );
