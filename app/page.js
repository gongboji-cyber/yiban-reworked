    ...
    <main className="container page-shell">
      <section className="hero-grid">
        ...
        <div className="glass-card hero-side">
          ...
          <div className="reality-check">
            <h3>为什么选择它</h3>
            <p>比起一次性给出空泛安慰，这个版本更重视真实记录、结构化整理与后续支持的连接。</p>
          </div>
        </div>
      </section>
      ...
      <section className="section-block compact-links">
        <div className="glass-card inline-links">
          <Link href="/auth" className="ghost-btn">注册 / 登录</Link>
          <Link href="/history" className="ghost-btn">查看我的记录</Link>
          <Link href="/admin/alerts" className="ghost-btn">进入教师导出端</Link>
        </div>
      </section>
    </main>
  );
